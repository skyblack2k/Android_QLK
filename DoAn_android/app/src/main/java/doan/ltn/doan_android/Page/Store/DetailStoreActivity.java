...
public class DetailStoreActivity extends AppCompatActivity {
    ...
    ModelCuaHang detailObj;
    ProductAdapter adapterMH;
    ArrayList<ModelMatHangHT> listMH;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Chi tiết cửa hàng");
    ...
    public void getID() {
        try {
            ...
            DetailTitle detailTitle = new DetailTitle("Tên cửa hàng:", "SDT:", "STK", "Ngân hàng:", "Đại diện:", "Ngày Tạo:", "Ngày cập nhật:", "Địa chỉ:","none");
    ...
    public void getData() {
        try{
            ...
            detailObj = (ModelCuaHang) intent.getExtras().getSerializable("DetailObj");
            ...
            recyclerView.setLayoutManager(new LinearLayoutManager(DetailStoreActivity.this, RecyclerView.VERTICAL,false));
            ...
            Toast.makeText(DetailStoreActivity.this, "Có lỗi xảy ra trong quá trình hiển thị dữ liệu!", Toast.LENGTH_LONG).show();
        }
    }
        ...
        try{
            ...
            APIServices.apiservices.MatHang_SearchPagingHT(token, htID, startTime, endTime,
                ...
                public void onResponse(Call<ResultListMatHangHT> call, Response<ResultListMatHangHT> response) {
                    ...
                    try{
                        ...
                        if(_listMH != null){
                            ...
                            Toast.makeText(DetailStoreActivity.this, "Không tìm thấy dữ liệu phù hợp!", Toast.LENGTH_LONG).show();
                        }
                    }
                    catch (Exception ex) {
                        Toast.makeText(DetailStoreActivity.this, "Có lỗi xảy ra trong quá trình nhận dữ liệu!", Toast.LENGTH_LONG).show();
                    }
                ...
                public void onFailure(Call<ResultListMatHangHT> call, Throwable t) {
                    Toast.makeText(DetailStoreActivity.this, "Có lỗi xảy ra trong quá trình gửi yêu cầu!", Toast.LENGTH_LONG).show();
                }
            });
        }
        catch (Exception ex){
            Toast.makeText(DetailStoreActivity.this, "Vui lòng kiểm tra đầu vào và thử lại!", Toast.LENGTH_LONG).show();
        }
    }
